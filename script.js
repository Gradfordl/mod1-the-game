...
class Villain extends Character {
    constructor(name, role, ability, attack) {
        super(name, role, ability, attack)
    }
...
const wizard = new Character ("Severus Snape", "Professor of the Dark Arts", "dark magic", 40);
const manticore = new Character ("Mighty Manticore", "Keeper of the Mountains", "will eat you.", 25);
const troll = new Character ("Angry Angus", "Keeper of the Bridge", "fighting", 25);
